...
from cafe.views import PositionListView, DishTypeListView, \
    ...
    OrderDeleteView, home, RecipeListView, RecipeUpdateView, \
    RecipeView, RecipeDeleteView
...
urlpatterns = [
    ...
    path("dish/recipe-ingredient/<int:pk>/update/", RecipeUpdateView.as_view(), name="recipe-ingredient-update"),
    path("dish/recipe-ingredient/<int:pk>/delete/", RecipeDeleteView.as_view(), name="recipe-ingredient-delete"),
